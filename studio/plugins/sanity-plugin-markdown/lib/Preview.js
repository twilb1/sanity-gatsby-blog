...
function Preview(props) {
  ...
  return _react.default.createElement(_reactMarkdown.default, _extends({}, options, {
...
Preview.propTypes = {
  ...
  options: _propTypes.default.shape({
    skipHtml: _propTypes.default.bool,
...
Preview.defaultOptions = _previewOptions.default;
